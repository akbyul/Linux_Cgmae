...
int	 control_file_struct(void)
{
	...
	SET_SCREEN_STRUCT(d_b, "new_game_2.txt", 10, 20);
	SET_SCREEN_STRUCT(d_c_1, "new_game_3.txt", 3, 10);
	SET_SCREEN_STRUCT(d_c_2, "new_game_3_slime.txt", 16, 14);
	SET_SCREEN_STRUCT(d_c_3, "new_game_3_slime_stats.txt", 16, 34);
